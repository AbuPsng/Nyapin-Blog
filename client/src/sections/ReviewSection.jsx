            ...
            <div className="flex gap-y-2 justify-center gap-x-8 h-36 w-full overflow-x-auto bg-teal-100 px-3 py-6 md:flex-row">
                {
                    !reviews.length > 0 ? <h3 className="text-xl font-semibold text-center">No Reviews Yet</h3>
                        ...
                        reviews?.map(review => (
                            ...
                            <div key={review._id} className={` ${review?.user?._id === user?.userId ? "order-first bg-blue-500 " : ""} flex relative rounded-md flex-col items-start gap-y-3 md:gap-y-6 p-2 md:p-4 bg-blue-200 hover:bg-blue-400 w-56 md:w-1/3 h-full`}>
