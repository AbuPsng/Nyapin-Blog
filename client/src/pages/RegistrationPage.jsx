        ...
        <Template>
            <main className="h-screen flex justify-center items-center">
                <form className="bg-gradient-to-t from-teal-400 to-blue-400 flex rounded-sm flex-col gap-y-4 p-12">
                    <input type="text" className="w-80 text-sm py-2 rounded-md px-4" placeholder="Enter your name" />
                    ...
                    <input type="text" className="w-80 text-sm py-2 rounded-md px-4" placeholder="Confirm password" />
